...
This documentation previously said `contextvars` carried the chain across
threads as well as tasks. That was wrong, and a deployment that believed it had
a weaker delegation control than it thought.
